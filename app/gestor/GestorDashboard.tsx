...
export default function GestorDashboard({
 ...
 {inativos7d.length} consultor{inativos7d.length> 1 ? 'es' : ''} sem estudar há mais de 7 dias
 </p>
...
>
 ...
 {new Date(aula.data_hora).toLocaleString('pt-BR', { timeZone: 'America/Sao_Paulo', day: '2-digit', month: '2-digit', year: 'numeric', hour: '2-digit', minute: '2-digit' })} · {aula.duracao_minutos} min
 </p>
 {aula.gravacao_url && <a href={aula.gravacao_url} target="_blank" rel="noopener noreferrer" style={{ fontSize: 13, color: '#8b5cf6', display: 'inline-flex', alignItems: 'center', gap: 4, marginTop: 6, fontWeight: 600 }}> Ver gravação</a>}
 </div>
 ...
 {([['templates', ' Templates'], ['consultores', ' Gerar para Consultor']] as const).map(([id, label]) => (
 <button key={id}
