          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div>
              ...
              <input type="email" placeholder="seu@email.com" value={form.email}
                ...
                style={{ width: '100%', background: 'rgba(30,58,138,0.6)', border: '1px solid rgba(59,130,246,0.4)', borderRadius: 8, padding: '12px 14px', color: '#fff', fontSize: 14, outline: 'none', boxSizing: 'border-box' }} />
            </div>
            <div>
              ...
              <div style={{ position: 'relative' }}>
                <input type={verSenha ? 'text' : 'password'} placeholder="••••••••" value={form.password}
                  ...
                  style={{ width: '100%', background: 'rgba(30,58,138,0.6)', border: '1px solid rgba(59,130,246,0.4)', borderRadius: 8, padding: '12px 44px 12px 14px', color: '#fff', fontSize: 14, outline: 'none', boxSizing: 'border-box' }} />
                <button type="button" onClick={() => setVerSenha(v => !v)}
                  style={{ position: 'absolute', right: 12, top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', cursor: 'pointer', color: 'rgba(255,255,255,0.75)', display: 'flex' }}>
                  {verSenha
